  ...
  const sections = [
    {
      ...
      btn2: ["All Service Requests","/admin-services/manage_services"],
      pathname: "/",
    },
    {
      title: "Manage Machines",
      btn1: ["New Registration", "/"],
      btn2: ["All Machines","/admin-services/manage_machines"],
      pathname: "/",
    },
    {
      title: "Manage Customers",
      btn1: ["New Registration", "/"],
      btn2: ["All Customers","/admin-services/manage_customers"],
    },
  ];
            ...
            <View className="flex-row gap-4 items-center">
              <View className=" ">
                ...
                <TouchableOpacity className="absolute top-0">
                  <FontAwesome name="bell" size={22} color={secondaryColor} />
                </TouchableOpacity>
          ...
          {sections.map((section, index) => (
            <View
              ...
              <View className="mt-4 flex-row justify-between gap-2">
                ...
                <TouchableOpacity onPress={() => router.push({ pathname: `${section.btn2[1]}` })}
                 className="flex-1 flex-row justify-center bg-black px-4 py-3 rounded-xl">
                  <Text className="text-white text-sm font-semibold">
                    {section.btn2[0]}
                  </Text>
